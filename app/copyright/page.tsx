  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-12 max-w-4xl">
      ...
      <div className="space-y-3">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">Copyright & DMCA Notice</h1>
      ...
      <div className="bg-white p-8 md:p-10 rounded-3xl border border-slate-200 shadow-sm space-y-6 text-slate-600 text-xs sm:text-sm leading-relaxed">
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">1. Platform Intellectual Property</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">2. Pinterest Content & Third-Party Rights</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">3. DMCA / Takedown Inquiries</h2>
          <p>
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 text-xs font-mono space-y-1 text-slate-800">
            <p className="font-semibold text-slate-900">Attn: Legal & Copyright Agent</p>
