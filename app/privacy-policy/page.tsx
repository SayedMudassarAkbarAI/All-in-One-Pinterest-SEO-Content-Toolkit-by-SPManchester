  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-12 max-w-4xl">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-slate-500">Effective Date: January 1, 2026 | Last Updated: 2026</p>
      </div>
      ...
      <div className="bg-white p-8 md:p-10 rounded-3xl border border-slate-200 shadow-sm space-y-6 text-slate-600 text-xs sm:text-sm leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">3. Information We Collect Automatically</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">4. Pinterest Downloader Utilities</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">5. Cookies & Analytics</h2>
          <p>
        ...
        <section className="space-y-2">
          ...
          <p className="text-slate-900 font-mono text-xs mt-1 bg-slate-50 p-3 rounded-xl border border-slate-200">
